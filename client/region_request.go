...
//func NewRegionRequestSender(regionCache *tikv.RegionCache, client Client) *RegionRequestSender {
...
//func (s *RegionRequestSender) SendReq(bo *tikv.Backoffer, req *tikvrpc.Request, regionID tikvrpc.RegionVerID, timeout time.Duration) (*Response, error) {
//
