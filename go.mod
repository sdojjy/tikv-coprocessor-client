module github.com/sdojjy/tikv-coprocessor-client
...
require (
	...
	github.com/pingcap/pd v0.0.0-20190522102323-c44ddf4abaaf
	github.com/pingcap/tidb v0.0.0-20190523040138-a4a7ef644010
